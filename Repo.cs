        ...
        private static Lazy<Dictionary<string, string[]>> _meatPizzas = new Lazy<Dictionary<string, string[]>>(() =>
            new Dictionary<string, string[]>()
            {
                ...
                { "Four Seasons",       new[] {"tomato", "mozzarella cheese", "basil leaves", "artichoke",
                                               ...
                                               "pecorino cheese" } },
                { "Flaming Chicken Hawaiian",   new[] { "chili chicken", "corn", "pineapple", "jalapeño pepper", "banana pepper", 
                                                        "hot buffalo sauce" } },
                { "Flaming Veggie Hawaiian",    new[] { "peanut", "corn", "pineapple", "jalapeño pepper", "banana pepper", 
                                                        "hot buffalo sauce" } },
